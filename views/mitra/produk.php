							...
							<table class="table table-hover" id="dataTable" width="100%" cellspacing="0">
								...
								<tbody>
									...
									<tr>
										...
										<td>
											<?php echo $product->jenisProduk ?>
										</td>
										<td>
											<?php echo "Rp. ".number_format($product->hargaProduk,2,',','.') ?>
										</td>
										<td>
											<img src="<?php echo base_url('gambar/produk/'.$product->gambar) ?>" width="64" />
										</td>
										<td>
											<?php echo $product->stokProduk ?>
										</td>
										
										<td class="small">
											<?php echo substr($product->deskProduk, 0, 120) ?>
										</td>
										
										<td>
											<a src="<?php echo base_url('dokumen/produk/'.$product->docProduk) ?>"  />
										</td>
										<td width="250">
											<a href="<?php echo site_url('produk/ubah/'.$product->idProduk) ?>"
											 class="btn btn-small"><i class="fas fa-edit"></i> Ubah</a>
											<a onclick="deleteConfirm('<?php echo site_url('produk/hapus/'.$product->idProduk) ?>')"
