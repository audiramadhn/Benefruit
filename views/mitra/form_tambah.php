					...
					<div class="card-body">
						...
						<form action="<?php base_url('produk/tambah') ?>" method="post" enctype="multipart/form-data" >
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('name') ? 'is-invalid':'' ?>"
								 type="text" name="harga" placeholder="Harga Produk" />
								<div class="invalid-feedback">
									<?php echo form_error('name') ?>
								</div>
							</div>
							...
							<div class="form-group">
								<label for="price">Estimasi Stok Produk Jadi / 1 kg*</label>
								<input class="form-control <?php echo form_error('price') ? 'is-invalid':'' ?>"
								 type="number" name="stiok" min="0" placeholder="Estimasi" />
								<div class="invalid-feedback">
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('price') ? 'is-invalid':'' ?>"
								 type="number" name="stiok" min="0" placeholder="Jangka Waktu Investasi" />
								<div class="invalid-feedback">
									<?php echo form_error('price') ?>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('price') ? 'is-invalid':'' ?>"
								 type="number" name="stiok" min="0" placeholder="Prosentase Keuntungan" />
								<div class="invalid-feedback">
									<?php echo form_error('price') ?>
								</div>
							</div>
