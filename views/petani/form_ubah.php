						...
						<form action="<?php base_url('produk/edit') ?>" method="post" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('namaProduk') ? 'is-invalid':'' ?>"
								 type="text" name="namaProduk" placeholder="Nama Produk" />
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('hargaProduk') ? 'is-invalid':'' ?>"
								 type="text" name="hargaProduk" placeholder="Harga Produk" />
								<div class="invalid-feedback">
							...
							<div class="form-group">
								...
								<input class="form-control-file <?php echo form_error('docProduk') ? 'is-invalid':'' ?>"
								 ...
								 <input type="hidden" name="dokumen_lawas" value="<?php echo $produk->docProduk ?>" />
								<div class="invalid-feedback">
							...
							<div class="form-group">
								...
								<textarea class="form-control <?php echo form_error('description') ? 'is-invalid':'' ?>"
								 name="deskProduk" placeholder="Deskripsi Produk..."><?php echo $produk->deskProduk ?></textarea>
								<div class="invalid-feedback">
