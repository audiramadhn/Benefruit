...
class Mitra extends CI_Controller{
    ...
    public function index(){
        ...
        $this->load->view('mitra/produk', $data);
    }
    ...
    public function ubah($id_produk = null){
        if(!isset($id_produk)) redirect('Mitra');
        $this->form_validation->set_rules($this->CrudModel->rules());
    ...
    public function investor_masuk(){
        $this->load->view('mitra/daftar_investor');
    }
    
    public function mitra(){
        $this->load->view('mitra/daftar_buah');
    }
}